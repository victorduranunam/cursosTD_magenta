...
class InstructorEvaluationController extends Controller
{
  public function index($participant_id) {
    try {
      ...
      if($instructor_evaluation)
        return redirect()->route('edit.instructor-evaluation', $instructor_evaluation->instructor_evaluation_id);
  ...
  public function edit($activity_instructor_id) {
  ...
  public function store(Request $req, $participant_id) {
    ...
    try{
            ...
            $instructor_evaluation->instructor_id = $req->instructor_id;
            $instructor_evaluation->participant_id = $participant_id;
  ...
  public function update(Request $req, $activity_instructor_id) {
