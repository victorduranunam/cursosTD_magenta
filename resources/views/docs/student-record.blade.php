...
<html lang="es">
  ...
  <head>
    <meta charset="UTF-8">
    <title>Historial de Actividades del Alumno</title>
  </head>
  ...
  <body>
    <div id="header">
      ...
      <div class="center-header">
        ...
        <h3>Historial de Actividades del Estudiante</h3> 
      </div>
    ...
    <div>
      ...
      <table>
        ...
        <tr>
          <td>Cursos Acreditados:    <b>{!! $student->activities->count() !!}</b></td>
          <td>Total de horas:    <b>{!! $student->activities->sum('hours') !!}h</b></td>
        </tr>    
      </table>
      <hr>
      <table>
