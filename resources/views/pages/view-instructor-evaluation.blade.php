                      ...
                      <table class="table table-hover">
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_9" value="50" {!! $instructor->evaluation->question_9 == 50 ? 'checked' : '' !!} class="form-check-input" id="question_9">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_9" value="60" {!! $instructor->evaluation->question_9 == 60 ? 'checked' : '' !!} class="form-check-input" id="question_9">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_9" value="80" {!! $instructor->evaluation->question_9 == 80 ? 'checked' : '' !!} class="form-check-input" id="question_9">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_9" value="95" {!! $instructor->evaluation->question_9 == 95 ? 'checked' : '' !!} class="form-check-input" id="question_9">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_9" value="100" {!! $instructor->evaluation->question_9 == 100 ? 'checked' : '' !!}   class="form-check-input" id="question_9">
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_10" value="50" {!! $instructor->evaluation->question_10 == 50 ? 'checked' : '' !!}  class="form-check-input" id="question_10">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_10" value="60" {!! $instructor->evaluation->question_10 == 60 ? 'checked' : '' !!}  class="form-check-input" id="question_10">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_10" value="80" {!! $instructor->evaluation->question_10 == 80 ? 'checked' : '' !!}  class="form-check-input" id="question_10">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_10" value="95" {!! $instructor->evaluation->question_10 == 95 ? 'checked' : '' !!}  class="form-check-input" id="question_10">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_10" value="100" {!! $instructor->evaluation->question_10 == 100 ? 'checked' : '' !!} }  class="form-check-input" id="question_9">
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_11" value="50" {!! $instructor->evaluation->question_11 == 50 ? 'checked' : '' !!}  class="form-check-input" id="question_11">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_11" value="60" {!! $instructor->evaluation->question_11 == 60 ? 'checked' : '' !!}  class="form-check-input" id="question_11">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_11" value="80" {!! $instructor->evaluation->question_11 == 80 ? 'checked' : '' !!}  class="form-check-input" id="question_11">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_11" value="95" {!! $instructor->evaluation->question_11 == 95 ? 'checked' : '' !!}  class="form-check-input" id="question_11">
                              </div>
                            </td>
                            <td align="center">
                              <div class="form-check">
                                <input disabled type="radio" name="question_11" value="100" {!! $instructor->evaluation->question_11 == 100 ? 'checked' : '' !!} }  class="form-check-input" id="question_9">
                              </div>
                            </td>
                          </tr>
                        </table>
