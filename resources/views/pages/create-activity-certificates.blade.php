...
<div class="card">
  <div class="card-header"><br>
    <h3>Generar Constancias <i class="bi bi-filetype-pdf"></i></h3>
  ...
  <div class="card-body">
    <br>
    <form  method="POST" action="{!! route('download.activity-certificates', $activity->activity_id) !!}">
      @csrf
      @method('post')
      <div class="row">
        <div class="col-xl-5">
      ...
      <div class="row">
        <div class="col-xl-12">
          ...
          <select class="form-select" name="text" id="text" onchange="updateCertificateCustomText()" onload="updateCertificateCustomText()">
            <option value="por haber acreditado">Por haber acreditado</option>
            <option value="por haber asistido">Por haber asistido</option>
            <option value="por haber sido parte">Por haber sido parte</option>
