...
<div class="card">
  <div class="card-header"><br>
    <h3>Actualizar Profesor <i class="bi bi-person-lines-fill"></i></h3>
  </div>
  ...
  <div class="card-body"><br>
    ...
    <div class="row">
        <div class="col-xl-4">
            ...
            <input required class="form-control" type="text" name="rfc" id="rfc" placeholder="Ej. RAVV900101FC4" value="{!!$professor->rfc !!}">
        </div>
        <div class="col-xl-4">
    ...
    <div class="row">
        ...
        <div class="col-xl-4">
          ...
          @if($professor->is_instructor)
            <div class="form-check">
              <input checked required class="form-check-input" type="radio" name="is_instructor" id="is_instructor" value="true">
          ...
          @else
            ...
            <div class="form-check">
              <input checked required class="form-check-input" type="radio" name="is_instructor" id="is_instructor" value="false">
              <label for="is_instructor" class="form-check-label">No</label>
            </div>
          @endif
