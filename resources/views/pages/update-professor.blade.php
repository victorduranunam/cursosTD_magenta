...
<div class="card">
  ...
  <div class="card-body"><br>
    <form  method="POST" action={!! route('update.professor', $professor->professor_id) !!}>
      ...
      <div class="row">
        ...
        <div class="col-xl-4">
          ...
          <input  class="form-control" type="text" name="mothers_last_name" id="mothers_last_name" placeholder="Ej. Villa" value="{!!$professor->mothers_last_name !!}">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-4">
            <label class="form-label" for="student_number">Número de alumno UNAM:</label>
            <input  class="form-control" type="text" name="student_number" id="student_number" placeholder="Ej. 962264" value="{!!$professor->student_number !!}">
        </div>
