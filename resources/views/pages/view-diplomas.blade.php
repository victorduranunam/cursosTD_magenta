...
<script>
    function alta() {
    document.getElementById('altaD').style.display = "block";
}
</script>
...
<div class="card">
    ...
    <div class="row justify-content-end">
      <div class="col-xl-3">
        <a href="#" id="alta" class="btn btn-outline-success" onclick="alta()">Alta Diplomado</a>
      </div>
      <div class="col-xl-2">
  ...
  @include('partials.messages')
    <div class="card-body"><br>
        ...
        <div id="altaD" style="display:none;">
            <form method="POST" action="{!! route('store.diploma') !!}">
                <h5>Alta diplomado</h5>
                @csrf
                @method('post')
                <div class="row">
                <div class="col-xl-6">
      ...
      <div class="row" style="margin: 1%">
        ...
        <div class="col-xl-2">  
          <form method="POST" action="{!! route('update.diploma', $diploma->diploma_id) !!}">
                  @csrf
                  @method('put')
                  <a type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#myModalu{!! $diploma->diploma_id !!}">Actualizar</a>
